...
public class Test1_StudentNotes_Sept4
  ...
  // It is not a Java statement, just a class declaration.
     ...
     */ 
    	...
    	int num = 0;		// Prepares the variable that will store the input.
    	  // Prepares a String object, initializing as an empty string.
     ...
     */
     	//System.out.print("\n\nThe character  in ASCII is 65. ");
     	//System.out.println("The character  in binary is 01000001.");
     	
     	//System.out.print("\nThe character  in ASCII is 66. ");
     	//System.out.println("The character  in binary is 01000010.");
     	
     	//System.out.print("\nThe character  in ASCII is 67. ");
     	//System.out.println("The character  in binary is 01000011.");
     	
     	//System.out.println("\nThe word  in binary is 01000011  01000001  01000010.\n\n");
     	...
     	// Prints true because it is comparing ? . This is true since the ASCII value of A is less than that of B.
     	...
     	//System.out.println("The ASCII value of 'A' is 65.");
     ...
     */
         ...
         //System.out.println(name.indexOf("W"));	// Prints 
         //System.out.println(name.indexOf("w"));	// Prints 
         //System.out.println(name.indexOf("o"));	// Prints  (only the first occurrence of 'o')
         //System.out.println(name.indexOf("X"));	// Prints  because 
         System.out.println();
         
         //System.out.println(name.charAt(0));		// Prints  the char at 
         //System.out.println(name.substring(1)); 	// Prints string starting at char 
         //System.out.println(name.substring(0,4)); 	// Prints string starting at char 
         System.out.println();
     ...
     */     
    	...
    	System.out.println();
    	//System.out.println( 6/5 + 1.0);		// 
    	System.out.println();
    	//System.out.println( 6/5.0 + 1);		// 
    	System.out.println();
    	...
    	//score ;			// equivalent to previous line but shorter; adds 10 to score; score now 100
    	//score ;			// subtracts 25 from score; score now 75
    	//score ;			// multiples score by 10; score now 750
    	//score ; 			// divides score by 5; score now 150
    	//score ;				// computes score mod 3; score now 0
    	...
    	//System.out.println( 14 / 2 * 5 );		//  division performed first since is left to right
     ...
     */     
     	...
     	double total ;		// Tells 1 to act like a double for this division.
